...
import { maintenanceItems } from "@/lib/data/maintenance-data";
import {
...
import { MaintenanceItem, DrivingCondition, Transmission } from "@/lib/data/types";
...
export default function Home() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const categorized = categorizeMaintenanceItems(maintenanceItems, vehicle);
